...
if not lspconfig_status then
	print("Lspconfig not found!") -- print error if plugin not installed
	return
end
...
if not cmp_nvim_lsp_status then
	print("Cmp_nvim_lsp not found!") -- print error if plugin not installed
	return
end
...
if not typescript_setup then
	print("Typescript not found found!") -- print error if plugin not installed
	return
end
